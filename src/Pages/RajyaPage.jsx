...
import { defaultRajyaPage } from '../data/rajyaPage'
...
function RajyaPage({ content, query }) {
  const section = content.rajyaPage ?? defaultRajyaPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Rajya page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?rajya=1&page=${pageNumber}`}
