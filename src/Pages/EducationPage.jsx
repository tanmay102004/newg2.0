...
import { defaultEducationPage } from '../data/educationPage'
...
function EducationPage({ content, query }) {
  const section = content.educationPage ?? defaultEducationPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Education page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?education=1&page=${pageNumber}`}
