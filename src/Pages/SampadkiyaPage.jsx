...
import { defaultSampadkiyaPage } from '../data/sampadkiyaPage'
...
function SampadkiyaPage({ content, query }) {
  const section = content.sampadkiyaPage ?? defaultSampadkiyaPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Sampadkiya page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?sampadkiya=1&page=${pageNumber}`}
