...
import { defaultSpecialPage } from '../data/specialPage'
...
function SpecialPage({ content, query }) {
  const section = content.specialPage ?? defaultSpecialPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Special page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?special=1&page=${pageNumber}`}
