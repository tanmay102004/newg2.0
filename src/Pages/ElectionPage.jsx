...
import { defaultElectionPage } from '../data/electionPage'
...
function ElectionPage({ content, query }) {
  const section = content.electionPage ?? defaultElectionPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Election page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?election=1&page=${pageNumber}`}
