...
import { defaultSehatPage } from '../data/sehatPage'
...
function SehatPage({ content, query }) {
  const section = content.sehatPage ?? defaultSehatPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Sehat page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?sehat=1&page=${pageNumber}`}
