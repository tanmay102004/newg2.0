...
import { defaultVideshPage } from '../data/videshPage'
...
function VideshPage({ content, query }) {
  const section = content.videshPage ?? defaultVideshPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Videsh page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?videsh=1&page=${pageNumber}`}
