...
import { defaultEntertainmentPage } from '../data/entertainmentPage'
...
function EntertainmentPage({ content, query }) {
  const section = content.entertainmentPage ?? defaultEntertainmentPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Entertainment page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?entertainment=1&page=${pageNumber}`}
