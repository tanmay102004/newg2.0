...
import { defaultKhelPage } from '../data/khelPage'
...
function KhelPage({ content, query }) {
  const section = content.khelPage ?? defaultKhelPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Khel page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?khel=1&page=${pageNumber}`}
