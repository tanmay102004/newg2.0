...
import { defaultDeshPage } from '../data/deshPage'
...
function DeshPage({ content, query }) {
  const section = content.deshPage ?? defaultDeshPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="Desh page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?desh=1&page=${pageNumber}`}
