...
import { defaultNewsPage } from '../data/newsPage'
...
function NewsPage({ content, query }) {
  const section = content.newsPage ?? defaultNewsPage
      ...
      <div className="breaking-page">
        <div className="breaking-page__layout">
          <section className="breaking-page__main">
            ...
            <nav className="breaking-page__pagination" aria-label="News page navigation">
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((pageNumber) => (
                <a
                  key={pageNumber}
                  href={`/?news=1&page=${pageNumber}`}
